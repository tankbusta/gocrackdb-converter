...
func (cpq *CrackedPasswordQuery) Where(ps ...predicate.CrackedPassword) *CrackedPasswordQuery {
...
func (cpq *CrackedPasswordQuery) Order(o ...OrderFunc) *CrackedPasswordQuery {
...
func (cpq *CrackedPasswordQuery) QueryRelatedTask() *TaskQuery {
	query := &TaskQuery{config: cpq.config}
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(crackedpassword.Table, crackedpassword.FieldID, selector),
			sqlgraph.To(task.Table, task.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, crackedpassword.RelatedTaskTable, crackedpassword.RelatedTaskColumn),
		)
...
// First returns the first CrackedPassword entity from the query.
// Returns a *NotFoundError when no CrackedPassword was found.
func (cpq *CrackedPasswordQuery) First(ctx context.Context) (*CrackedPassword, error) {
	nodes, err := cpq.Limit(1).All(ctx)
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{crackedpassword.Label}
	}
	return nodes[0], nil
}

// FirstX is like First, but panics if an error occurs.
func (cpq *CrackedPasswordQuery) FirstX(ctx context.Context) *CrackedPassword {
...
// FirstID returns the first CrackedPassword ID from the query.
// Returns a *NotFoundError when no CrackedPassword ID was found.
...
// Only returns a single CrackedPassword entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when exactly one CrackedPassword entity is not found.
// Returns a *NotFoundError when no CrackedPassword entities are found.
func (cpq *CrackedPasswordQuery) Only(ctx context.Context) (*CrackedPassword, error) {
	...
	case 0:
		return nil, &NotFoundError{crackedpassword.Label}
	default:
		return nil, &NotSingularError{crackedpassword.Label}
	}
}

// OnlyX is like Only, but panics if an error occurs.
func (cpq *CrackedPasswordQuery) OnlyX(ctx context.Context) *CrackedPassword {
...
// OnlyID is like Only, but returns the only CrackedPassword ID in the query.
// Returns a *NotSingularError when exactly one CrackedPassword ID is not found.
...
func (cpq *CrackedPasswordQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	...
	case 0:
		err = &NotFoundError{crackedpassword.Label}
	default:
		err = &NotSingularError{crackedpassword.Label}
	}
	return
}
...
func (cpq *CrackedPasswordQuery) All(ctx context.Context) ([]*CrackedPassword, error) {
	if err := cpq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (cpq *CrackedPasswordQuery) AllX(ctx context.Context) []*CrackedPassword {
...
func (cpq *CrackedPasswordQuery) IDs(ctx context.Context) ([]uuid.UUID, error) {
	var ids []uuid.UUID
	if err := cpq.Select(crackedpassword.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
// Clone returns a duplicate of the CrackedPasswordQuery builder, including all associated steps. It can be
// used to prepare common query builders and use them differently after the clone is made.
func (cpq *CrackedPasswordQuery) Clone() *CrackedPasswordQuery {
	if cpq == nil {
		return nil
	}
	return &CrackedPasswordQuery{
		config:          cpq.config,
		limit:           cpq.limit,
		offset:          cpq.offset,
		order:           append([]OrderFunc{}, cpq.order...),
		predicates:      append([]predicate.CrackedPassword{}, cpq.predicates...),
		withRelatedTask: cpq.withRelatedTask.Clone(),
...
// WithRelatedTask tells the query-builder to eager-load the nodes that are connected to
// the "related_task" edge. The optional arguments are used to configure the query builder of the edge.
func (cpq *CrackedPasswordQuery) WithRelatedTask(opts ...func(*TaskQuery)) *CrackedPasswordQuery {
	query := &TaskQuery{config: cpq.config}
	for _, opt := range opts {
		opt(query)
	}
	cpq.withRelatedTask = query
	return cpq
}
...
func (cpq *CrackedPasswordQuery) GroupBy(field string, fields ...string) *CrackedPasswordGroupBy {
	group := &CrackedPasswordGroupBy{config: cpq.config}
...
func (cpq *CrackedPasswordQuery) Select(fields ...string) *CrackedPasswordSelect {
	...
	return &CrackedPasswordSelect{CrackedPasswordQuery: cpq}
}

func (cpq *CrackedPasswordQuery) prepareQuery(ctx context.Context) error {
...
func (cpq *CrackedPasswordQuery) sqlAll(ctx context.Context) ([]*CrackedPassword, error) {
	var (
		nodes       = []*CrackedPassword{}
		withFKs     = cpq.withFKs
		_spec       = cpq.querySpec()
		loadedTypes = [1]bool{
			cpq.withRelatedTask != nil,
		}
	)
	if cpq.withRelatedTask != nil {
		withFKs = true
	}
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, crackedpassword.ForeignKeys...)
	}
	_spec.ScanValues = func(columns []string) ([]interface{}, error) {
		node := &CrackedPassword{config: cpq.config}
	...
	if query := cpq.withRelatedTask; query != nil {
		ids := make([]uuid.UUID, 0, len(nodes))
		nodeids := make(map[uuid.UUID][]*CrackedPassword)
		for i := range nodes {
			if nodes[i].task_cracked_passwords == nil {
				continue
			}
			fk := *nodes[i].task_cracked_passwords
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "task_cracked_passwords" returned %v`, n.ID)
			}
			for i := range nodes {
				nodes[i].Edges.RelatedTask = n
			}
		}
	}
...
func (cpq *CrackedPasswordQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := cpq.querySpec()
	if len(cpq.modifiers) > 0 {
		_spec.Modifiers = cpq.modifiers
	}
...
func (cpq *CrackedPasswordQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (cpq *CrackedPasswordQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := cpq.fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != crackedpassword.FieldID {
...
func (cpq *CrackedPasswordQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(cpq.driver.Dialect())
	t1 := builder.Table(crackedpassword.Table)
	columns := cpq.fields
	if len(columns) == 0 {
		columns = crackedpassword.Columns
	}
...
func (cpgb *CrackedPasswordGroupBy) Aggregate(fns ...AggregateFunc) *CrackedPasswordGroupBy {
...
func (cpgb *CrackedPasswordGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cpgb.fields) > 1 {
		return nil, errors.New("ent: CrackedPasswordGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cpgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cpgb *CrackedPasswordGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{crackedpassword.Label}
	default:
		err = fmt.Errorf("ent: CrackedPasswordGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cpgb *CrackedPasswordGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cpgb.fields) > 1 {
		return nil, errors.New("ent: CrackedPasswordGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cpgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cpgb *CrackedPasswordGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{crackedpassword.Label}
	default:
		err = fmt.Errorf("ent: CrackedPasswordGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cpgb *CrackedPasswordGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cpgb.fields) > 1 {
		return nil, errors.New("ent: CrackedPasswordGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cpgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cpgb *CrackedPasswordGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{crackedpassword.Label}
	default:
		err = fmt.Errorf("ent: CrackedPasswordGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cpgb *CrackedPasswordGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cpgb.fields) > 1 {
		return nil, errors.New("ent: CrackedPasswordGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cpgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cpgb *CrackedPasswordGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{crackedpassword.Label}
	default:
		err = fmt.Errorf("ent: CrackedPasswordGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cpgb *CrackedPasswordGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (cpgb *CrackedPasswordGroupBy) sqlQuery() *sql.Selector {
...
func (cps *CrackedPasswordSelect) Scan(ctx context.Context, v interface{}) error {
	...
	cps.sql = cps.CrackedPasswordQuery.sqlQuery(ctx)
...
func (cps *CrackedPasswordSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cps.fields) > 1 {
		return nil, errors.New("ent: CrackedPasswordSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cps *CrackedPasswordSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{crackedpassword.Label}
	default:
		err = fmt.Errorf("ent: CrackedPasswordSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cps *CrackedPasswordSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cps.fields) > 1 {
		return nil, errors.New("ent: CrackedPasswordSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cps *CrackedPasswordSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{crackedpassword.Label}
	default:
		err = fmt.Errorf("ent: CrackedPasswordSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cps *CrackedPasswordSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cps.fields) > 1 {
		return nil, errors.New("ent: CrackedPasswordSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cps *CrackedPasswordSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{crackedpassword.Label}
	default:
		err = fmt.Errorf("ent: CrackedPasswordSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cps *CrackedPasswordSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cps.fields) > 1 {
		return nil, errors.New("ent: CrackedPasswordSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cps *CrackedPasswordSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{crackedpassword.Label}
	default:
		err = fmt.Errorf("ent: CrackedPasswordSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cps *CrackedPasswordSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
